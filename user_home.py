            ...
            with st.sidebar:
                ...
                st.markdown(
                    ...
                    <div class="center-image">
                        <img src="https://cdn.iconscout.com/icon/free/png-256/free-avatar-icon-download-in-svg-png-gif-file-formats--user-boy-avatars-flat-icons-pack-people-456322.png" width="250">
                    </div>
                    """,
                    unsafe_allow_html=True,
                )
